...
tinyMCE.init({
	...
	// Theme options
	theme_advanced_buttons1 : "newdocument,spellchecker,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,clearfloat,|,bullist,numlist,|,formatselect,fontsizeselect,fontselect,|,code,styleprops",
	theme_advanced_buttons2 : "undo,redo,|,cut,copy,paste,pastetext,pasteword,|,pastehtml,pastecode,|,search,replace,|,link,unlink,anchor,|,image,media,|,removeformat,cleanup,|,insertdate,inserttime,advhr,cite,abbr,acronym,|,charmap,exemath",
	theme_advanced_buttons3 : "template,|,tablecontrols,|,forecolor,backcolor,|,sub,sup,|,outdent,indent,blockquote,|,del,ins,attribs,nonbreaking,|,fullscreen,help",
