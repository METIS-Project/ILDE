    ...
    window.Media = {
        ...
        moveStates : function(to_form, field) {
            ...
            if (!to_form) {
                ...
                if (data.type == "video" || data.type == "audio") {
                    data.video.attrs = {};
                    data.video.attrs.class = getVal('mediaelement') ? 'mediaelement' : false;
                    data.video.attrs.autoplay = getVal('autoplayelement') ? 'autoplay' : false;
                    data.video.attrs.controls = getVal('controlselement') ? 'controls' : false;
                }
            }
            ...
            if (get(data.type + '_options')) {
                ...
                get('filebrowsercontainer').innerHTML = getBrowserHTML('filebrowser','src',data.type,'media');
            }
