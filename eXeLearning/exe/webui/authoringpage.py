        ...
        if "action" in request.args:
            ...
            if request.args["action"][0] == "done":
                if activeClient:
                    ...
                    return "<!DOCTYPE html>\n<html><head></head><body><script>location.replace(\"" + request.path + "?clientHandleId=" + activeClient.handleId + "\");</script></body></html>"
                    #return "<!DOCTYPE html>\n<html><head></head><body onload=\"console.log(window)\"></body></html>"
                else:
