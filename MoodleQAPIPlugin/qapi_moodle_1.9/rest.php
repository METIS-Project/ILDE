...
case 'course':
	...
	case 'userlist':
        ...
        break;	
	//Modificación de Juan para incluir un listado de grupos y miembros por curso
	case 'grouplist':
		include_once "course_group_list.inc";    //get user from a course
        $resource = new Course_Group_List;
        break;	
	// Modificación de Juan para incluir un listado de los cursos en donde un usuario es admin
	case 'useradmin':
		include_once "all_courses_admin.inc";    //get all courses
        $resource = new All_Courses_Admin;
        break;	
    case 'credentials':
		include_once "check_credentials.inc";    //get all courses
        $resource = new Check_Credentials;
        break;
    default:
...
//añadido por Juan para que el content-type de la cabecera http sea application/json
