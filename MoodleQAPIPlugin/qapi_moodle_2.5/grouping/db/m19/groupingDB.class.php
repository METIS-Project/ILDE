...
/**
 * Grouping Database Class for Moodle 1.9
 *
 * @package GlueServer
 * @subpackage grouping
...
require_once(dirname(__FILE__).'/../groupingDBbase.class.php');
class glueserver_grouping_db extends glueserver_grouping_db_base{
}
?>