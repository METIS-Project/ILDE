<?php
		...
		ArrayAccess // Override for array access
	{
		 ...
		 * And keep the time_updated field intact
		 */
...
//				}
	 ...
	 * @param int $access_id
	 */
	function update_entity($guid, $owner_guid, $access_id, $keep_time_updated = false)
	{
		...
		if ($entity->canEdit()) {
			...
			if (trigger_elgg_event('update',$entity->type,$entity)) {
				...
				if (!$keep_time_updated)
					...
					$ret = update_data("UPDATE {$CONFIG->dbprefix}entities set owner_guid='$owner_guid', access_id='$access_id' WHERE guid=$guid");
				/// LdShake change ///
	 ...
	 */
	function get_entities_where($whereClauses, $type = "", $subtype = "", $owner_guid = 0, $order_by = "", $limit = 10, $offset = 0, $count = false, $site_guid = 0, $container_guid = null)
	{
		global $CONFIG;
		...
		//Pau: THe manual where is added here
		$where[] = $whereClauses;
