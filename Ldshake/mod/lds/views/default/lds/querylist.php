...
if($url == "http://ilde.upf.edu/") {
    ...
    if(!strcmp("$patternsname","Jigsaw")) {$lhref="{$url}pg/lds/view/2092/";$t_text = "If groups of students face resolution of a complex problem/task that can be easily divided into sections or independent sub-problems, an adequate collaborative learning flow may be planned.";}
