	...
	<div id="one_column" style="padding-bottom:0 !important">
		<div id="lds_edit_form" action="<?php echo $url ?>" method="post">
			...
			<div id="lds_edit_contents">
                ...
                <?php if(strstr($editor, 'google')): ?>
                    <div class="google-docs-blocking-user">
                        <?php if(strstr($editor, 'google_draw')): ?>
                            <div id="lds_edit_save_fullscreen" class="save"><?php echo T("Save");?></div>
                            <div id="lds_edit_buttons_fullscreen"></div>
                            <div class="switch">Switch fullscreen</div>
                        <?php endif; ?>
                    </div>
