                ...
                <?php foreach($list as $item): ?>
					...
					<span class="lds_title_tags">
                        ...
                        <?php echo lds_viewTools::all_tag_display ($item->lds) ?>
                                ...
                                <span class="lds_people"><?php echo $item->starter->name ?> to <?php echo $item->num_editors ?> editor<?php if ($item->num_editors != 1): ?><?php echo T('s');?><?php endif; ?>, <?php if($item->num_viewers == -1): ?>all<?php else: ?><?php echo $item->num_viewers ?><?php endif; ?> <?php if ($item->num_viewers != 1): ?><?php echo T("viewers"); ?><?php else: ?><?php echo T("viewer"); ?><?php endif; ?>
                                <?php if ($item->locked): ?>
