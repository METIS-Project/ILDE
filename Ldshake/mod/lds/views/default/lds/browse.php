...
<div id="two_column_left_sidebar">
	<div id="owner_block">
		<div id="left_filters">
            ...
            ?><li>
                <a class="lds_tag" href="<?php echo $url ?>pg/lds/browse/?tagk=<?php echo urlencode($template['type_label']) ?>&tagv=<?php echo urlencode($template['type_value']) ?>&filter=<?php echo rawurlencode($filter) ?>"><?php echo htmlspecialchars($template['title']) ?></a> <span class="freq"><?php echo htmlspecialchars($template['count']) ?></span>
            </li><?php
            endforeach;
            ?>
