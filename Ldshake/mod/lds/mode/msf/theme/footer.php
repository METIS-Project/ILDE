...
<div id="layout_footer">
    <div id="footer-logos">
        <ul>
            ...
            <li><a href="http://ecampus.msf.org/moodlemsf/" target="_blank"><img src="<?php echo $url ?>_graphics/logoMSF.png" height="56" alt="MEDECINS SANS FRONTIERES" style="margin-right: 2px"></a></li>
