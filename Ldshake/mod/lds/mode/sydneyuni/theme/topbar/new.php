...
<div id="new_menu_author" class="menu level2">
    <ul>
        <li id="tb_newlds_rea" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/upload/reauthoring/"><?php echo T("Reauthoring") ?></a></li>
...
<div id="new_menu_conceptualize" class="menu level2">
    <ul>
        ...
        <li id="tb_conceptualize_new1" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/new/template/agile_user_stories"><?php echo T("Agile User Stories") ?></a></li>
        <li id="tb_conceptualize_new1" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/new/template/practice_narrative"><?php echo T("Practice Narrative") ?></a></li>
        <li id="tb_conceptualize_new1" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/new/template/practice_pattern"><?php echo T("Practice Pattern") ?></a></li>
        ...
        <li id="tb_conceptualize_new10" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/new/"><?php echo T("For other conceptualizations (Web editor)") ?></a></li>
        ...
        <li id="tb_conceptualize_new13" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/neweditor/google_draw/template/google_draw"><?php echo T("For other conceptualizations (Google Draw)") ?></a></li>
