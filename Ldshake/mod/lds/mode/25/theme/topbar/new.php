<div id="toolbar_lds_types" class="menu">
    <ul>
        ...
        <li id="tb_conceptualize_new5" class="menu_option"><a href="<?php echo $vars['url']; ?>pg/lds/neweditor/google_docs/"><?php echo T("For other conceptualizations (Google Docs)") ?></a></li>
