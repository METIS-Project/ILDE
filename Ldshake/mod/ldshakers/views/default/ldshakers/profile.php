...
<div id="two_column_left_sidebar">
	<div id="owner_block">
        ...
        <ul id="lds_side_sections">
            ...
            <li><div class="profile_counter <?php if($section == "coedited") echo "current"?>"><?php echo $activity_counters['coedition'];?></div><a class="<?php if($section == "coedited") echo "current"?>" href="<?php echo $url ?>pg/ldshakers/<?php echo $cuser->username ?>/coedited"><?php echo T("Co-design contributions") ?></a></li>
