...
<div id="elgg_topbar_container_left">
	...
	<div class="toolbarlinks">
		...
		<a href="<?php echo $vars['url']; ?>mod/help/index.php" class="usersettings"><?php echo elgg_echo('help'); ?></a>
		<a href="<?php echo $vars['url']; ?>mod/about/index.php" class="usersettings"><?php echo elgg_echo('about'); ?></a>
		<?php
