...
function natcompareTag(a,b) {
	 var a = Deploy.buscarTag(a,"title").childNodes[0].nodeValue;
	 var b = Deploy.buscarTag(b,"title").childNodes[0].nodeValue;
	 
	 return natcompare(a,b);
}

function natcompareName(a,b) {
	 var a = a.name;
	 var b = b.name;
...
function natcompareByGroupName(a,b) {
	var ga = GroupContainer.getGroup(a.groupId);
	var gb = GroupContainer.getGroup(b.groupId);
    var a = ga.getName().toLowerCase();
    var b = gb.getName().toLowerCase();
    
    return natcompare(a,b);
}
    
function natcompareByToolName(a,b) {
        var a = a.value;
        var b = b.value;
