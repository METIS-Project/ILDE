...
if [ -z $GLUEPSMETIS_HOME ] 
then
	GLUEPSMETIS_HOME=$(pwd)
	GLUEPSMETIS_HOME=$GLUEPSMETIS_HOME/../..
	echo Environment value GLUEPSMETIS_HOME is not defined
	echo Assuming default value: $GLUEPSMETIS_HOME
#	echo "Environment variable GLUEPS_HOME must be defined"
#	exit 1
fi

# Basic locations
GM_HOME=$GLUEPSMETIS_HOME/manager
CONF_DIR=$GM_HOME/conf
GLUEPS_LIB_DIR=$GLUEPSMETIS_HOME/lib
...
CLASSPATH="."
CLASSPATH=$CLASSPATH:$GM_LIB_DIR/glue-common.jar
...
CLASSPATH=$CLASSPATH:$GM_LIB_DIR/commons-email-1.3.1jar
