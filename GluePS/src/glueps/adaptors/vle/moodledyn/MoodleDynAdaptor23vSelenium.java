...
public class MoodleDynAdaptor23vSelenium extends MoodleAdaptor21vSelenium implements
		IDynamicVLEDeployer {
	...
	public MoodleDynAdaptor23vSelenium() {
	}

	public MoodleDynAdaptor23vSelenium(String base, String template, String moodleUrl, String moodleUser, String moodlePassword, Map<String, String> parameters) {
		super(base, template, moodleUrl, moodleUser, moodlePassword, parameters);
	}

	public MoodleDynAdaptor23vSelenium(String base, String template, String modelPackage,
