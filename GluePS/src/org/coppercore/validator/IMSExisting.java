...
/**
 * Represents a ref to an existing item resource.
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/11 13:15:02 $
 */
public class IMSExisting extends IMSObject {
  public IMSExisting() {
    // default constructor
  }

  protected void isValid() throws SemanticException {
    // IMSexisting object is always semantically valid
  }
  ...
  protected void initialize(Node anItemNode, IMSLDManifest aManifest) {
    ...
    String uri = ((Element) anItemNode).getAttribute("href");
