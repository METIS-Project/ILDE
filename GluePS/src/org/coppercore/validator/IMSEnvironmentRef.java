...
/**
 * This class represents a ref to an environment.
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/11 13:15:02 $
 */
public class IMSEnvironmentRef
    extends IMSRef {

  public IMSEnvironmentRef() {
    // default constructor
  }
  ...
  protected void initialize(Node anItemNode, IMSLDManifest aManifest) {
    ...
    refersTo.add("environment");
    referingNode = "environment-ref";
  }
}
