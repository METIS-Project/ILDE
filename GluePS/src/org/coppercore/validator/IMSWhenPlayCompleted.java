...
/**
 * This class represents an ims learning design when-play-completed element.
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/11 13:15:03 $
 */
public class IMSWhenPlayCompleted
    extends IMSRef {

  public IMSWhenPlayCompleted() {
    // default constructor
  }
  ...
  protected void initialize(Node anItemNode, IMSLDManifest aManifest) {
    ...
    refersTo.add("play");
    referingNode = "when-play-completed";
  }
}
