...
public class CurrentDateTime extends Operand {
  ...
  public LDDataType evaluate(Uol uol, Run run, User user) throws
    ...
    return new LDDateTime(Calendar.getInstance());
  }

  public void toXml(PrintWriter out) {
    XMLTag tag = new XMLTag(Operand.CURRENTDATETIME);
  ...
  public void getTriggers(HashMap propertyTriggers, HashMap timerTriggers,
    ...
    final String TRIGGERID = "current-date-time";
