 ...
 * @version $Revision: 1.19 $, $Date: 2007/04/04 09:04:07 $
 */
public class PropertyFacade implements Serializable {
   ...
   */
  public PropertyFacade(int runId, String userId, String propId, int scope, String propValue,
   ...
   */
  public PropertyFacade(int uolId, int runId, String userId, String propId) throws FinderException {
		long startTime = System.currentTimeMillis();
    pe = getHome().findByLookUp(uolId, propId, userId, runId);
  	//TODO enable optional debug statement here
  	//System.out.println("Property facade fetch: " + (System.currentTimeMillis() - startTime));
  }
  ...
  public PropertyDto getDto() {
		...
		PropertyDto dto = pe.getDto();
  	//TODO enable optional debug statement here
  	//System.out.println("DTO fetch: " + (System.currentTimeMillis() - startTime));
    return dto;
  }
