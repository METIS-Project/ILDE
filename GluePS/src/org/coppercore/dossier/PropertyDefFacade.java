 ...
 * @version $Revision: 1.17 $, $Date: 2007/04/04 09:04:08 $
 */
public class PropertyDefFacade
   ...
   */
  public PropertyDefFacade(int scope, String dataType, String href,
   ...
   */
  public PropertyDefFacade(PropertyDefDto dto) throws CreateException {
   ...
   */
  public PropertyDefFacade(int uolId, String propId) throws FinderException {
		long startTime = System.currentTimeMillis();
    pde = getHome().findByLookUp(uolId, propId);
  	//TODO enable optional debug statement here
  	//System.out.println("Initial DEFDTO fetch: " + (System.currentTimeMillis() - startTime));
  }
   ...
   */
  public PropertyDefFacade(String uri) throws FinderException {
    pde = getHome().findByUri(uri);
  }

  private PropertyDefFacade(PropertyDefEntity pde) {
    this.pde = pde;
  }
  ...
  public PropertyDefDto getDto() {
		long startTime = System.currentTimeMillis();
		PropertyDefDto dto = pde.getDto();
  	//TODO enable optional debug statement here
  	//System.out.println("_DEFDTO fetch: " + (System.currentTimeMillis() - startTime));
  ...
  public static Collection findPropertyDefinitionFacadeByUol(int uolId) throws
    ...
    while (iter.hasNext()) {
      ...
      result.add(new PropertyDefFacade(propDefEntity));
    }
