...
/**
 * The class IllegalOperationException denotes errors a reasonable applications
 * might want to catch.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2007/03/30 08:23:23 $
 */
public class IllegalOperationException extends ExpressionException {
   ...
   */
  public IllegalOperationException(Exception ex) {
    super(ex);
  }
}
