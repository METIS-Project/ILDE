...
/**
 * The class PropertyCreationException denotes errors a reasonable applications
 * might want to catch.
 *
...
public class PropertyCreationException extends PropertyException {
   ...
   */
  public PropertyCreationException(String aMessage) {
    super(aMessage);
  }
   ...
   */
  public PropertyCreationException(Exception ex) {
    super(ex);
  }
}
