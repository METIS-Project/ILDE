...
/**
 * The class DivideByZeroException denotes errors a reasonable applications
 * might want to catch.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.5 $, $Date: 2007/03/30 08:23:25 $
 */
public class DivideByZeroException extends ExpressionException {
   ...
   */
  public DivideByZeroException(String aMessage) {
    super(aMessage);
  }
   ...
   */
  public DivideByZeroException(Exception ex) {
    super(ex);
  }
}
