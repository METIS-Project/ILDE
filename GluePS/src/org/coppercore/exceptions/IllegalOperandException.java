...
/**
 * The class IllegalOperandException denotes errors a reasonable applications
 * might want to catch.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2007/03/30 08:23:24 $
 */
public class IllegalOperandException extends ExpressionException {
   ...
   */
  public IllegalOperandException(String aMessage) {
    super(aMessage);
  }
   ...
   */
  public IllegalOperandException(Exception ex) {
    super(ex);
  }
}
