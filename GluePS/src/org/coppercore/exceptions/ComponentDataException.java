...
/**
 * The class ComponentDataException denotes errors a reasonable applications
 * might want to catch.
 *
 ...
 */
public class ComponentDataException extends PropertyException {
   ...
   */
  public ComponentDataException(String aMessage) {
    super(aMessage);
  }
   ...
   */
  public ComponentDataException(Exception ex) {
    super(ex);
  }
}
