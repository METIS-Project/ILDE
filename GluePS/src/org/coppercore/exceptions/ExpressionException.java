...
/**
 * The class ExpressionException denotes errors a reasonable applications might
 * want to catch. It is the base exception class for a validation exceptions.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2007/03/30 08:23:29 $
 */
public abstract class ExpressionException
   ...
   */
  public ExpressionException(String aMessage) {
    super(aMessage);
  }
