...
/**
 * The class NullValueException denotes errors a reasonable applications might
 * want to catch.
 *
 ...
 */
public class NullValueException extends ExpressionException {
   ...
   */
  public NullValueException(String aMessage) {
    super(aMessage);
  }
