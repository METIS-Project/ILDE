...
/**
 * The class CopperCoreException denotes errors a reasonable applications might
 * want to catch.
 * 
 ...
 */
public class CopperCoreException extends Exception {
   ...
   */
  public CopperCoreException(String message) {
    super(message);
  }
   ...
   *          unknown.)
   */
  public CopperCoreException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * and detail message of <tt>cause</tt>). This constructor is useful for
   * exceptions that are little more than wrappers for other throwables (for
   * example, {@linkjava.security.PrivilegedActionException}).
   * 
   * @param cause
   *          the cause (which is saved for later retrieval by the
   *          {@link #getCause()}method). (A<tt>null</tt> value is
   ...
   *          unknown.)
   */
  public CopperCoreException(Throwable cause) {
    super(cause);
  }
