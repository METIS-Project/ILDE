...
/**
 * This class represents the definition of IMS-LD uri property.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.11 $, $Date: 2005/01/19 16:31:26 $
 */
public class UriPropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 42L;

  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDURI_NAME;
   ...
   */
  public UriPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public UriPropertyDef(int uolId, String propId, int scope, String dataType,
   ...
   */
  public UriPropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
