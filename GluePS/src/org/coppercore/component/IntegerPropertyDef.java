...
/**
 * This class represents the definition of IMS-LD integer property.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.18 $, $Date: 2005/01/19 16:31:27 $
 */
public class IntegerPropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 42L;
  
  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDINTEGER_NAME;
   ...
   */
  public IntegerPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public IntegerPropertyDef(int uolId, String propId, int scope,
                            String dataType,
   ...
   */
  public IntegerPropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
