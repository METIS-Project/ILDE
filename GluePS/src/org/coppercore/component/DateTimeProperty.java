...
/**
 * This Property represents an IMS LD datetime Property. It extends
 ...
 */
public class DateTimeProperty extends ExplicitProperty {
   ...
   */
  public DateTimeProperty(Uol uol, Run run, User user, String propId) throws
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new DateTimePropertyDef(uolId, propId);
  }
