...
/**
 * This Property represents an IMS LD uri Property. It extends
 ...
 */
public class UriProperty extends ExplicitProperty {
   ...
   */
  public UriProperty(Uol uol, Run run, User user, String propId) throws
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new UriPropertyDef(uolId, propId);
  }
