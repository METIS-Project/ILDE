...
/**
 * The class represent the IMS LD defintion of an SendMail. An
 * SendMailPropertyDef is an instance of a LocalPersonalContentDef.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.11 $, $Date: 2005/01/21 10:58:48 $
 */
public class SendMailPropertyDef
   ...
   */
  public static final String DATATYPE = "send-mail";
   ...
   */  
  public SendMailPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */  
  public SendMailPropertyDef(int uolId, String propId, String isVisible, String contentXml, Collection items) {
