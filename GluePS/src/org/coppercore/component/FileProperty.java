...
/**
 * This Property represents an IMS LD file Property. It extends ExplicitProperty
 * adding type cast and restriction checking to the standard Property mechanism.
 * Note that only the metadata of the file property will be stored. The actual
 * content of the file is not handled by the enginge.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.9 $, $Date: 2005/01/19 16:31:26 $
 */
public class FileProperty extends ExplicitProperty {
   ...
   */
  public FileProperty(Uol uol, Run run, User user, String propId) throws
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new FilePropertyDef(uolId, propId);
  }
