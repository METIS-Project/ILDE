...
import org.coppercore.datatypes.LDFile;
...
/**
 * This class represents the definition of IMS-LD file property.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.9 $, $Date: 2005/01/19 16:31:26 $
 */
public class FilePropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 42L;

  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDFILE_NAME;
   ...
   */
  public FilePropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public FilePropertyDef(int uolId, String propId, int scope, String dataType,
                         String href,
    ...
    super(uolId, propId, scope, dataType, href, null, restrictions,
   ...
   */
  public FilePropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
