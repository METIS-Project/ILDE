 ...
 * @version $Revision: 1.10 $, $Date: 2005/01/19 16:31:27 $
 */
public class BooleanProperty extends ExplicitProperty {
   ...
   */
  public BooleanProperty(Uol uol, Run run, User user, String propId) throws
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new BooleanPropertyDef(uolId, propId);
  }
