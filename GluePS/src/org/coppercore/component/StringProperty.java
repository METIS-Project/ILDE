 ...
 */
public class StringProperty extends ExplicitProperty {
   ...
   */
  public StringProperty(Uol uol, Run run, User user, String propId) throws
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new StringPropertyDef(uolId, propId);
  }
  ...
  protected LDDataType createPropertyValue(String aValue) throws
      TypeCastException {
    LDString result = null;
    if (aValue != null) {
      result =  new LDString(aValue);
    }
    return result;
  }
