...
/**
 * The class represent the IMS LD ActivityStructure. An ActivityStructure
 * behaves simular to all other activities.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.11 $, $Date: 2005/01/20 16:12:03 $
 */
public class ActivityStructureProperty extends Activities {
   ...
   */
  public ActivityStructureProperty(Uol uol, Run run, User user, String propId) throws PropertyException {
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new ActivityStructurePropertyDef(uolId, propId);
  }
}
