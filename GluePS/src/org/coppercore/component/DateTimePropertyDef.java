...
/**
 * This class represents the definition of IMS-LD datetime property.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.11 $, $Date: 2005/01/19 16:31:28 $
 */

public class DateTimePropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 1L;
  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDDATETIME_NAME;
   ...
   */
  public DateTimePropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public DateTimePropertyDef(int uolId, String propId, int scope, String dataType,
   ...
   */
  public DateTimePropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
