...
/**
 * This component represents the IMS LD environment. This components extends the
 * LocalPersonalContent.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.8 $, $Date: 2005/01/19 16:31:27 $
 */
public class EnvironmentProperty extends LocalPersonalContent {
   ...
   */
  public EnvironmentProperty(Uol uol, Run run, User user, String propId) throws PropertyException {
  ...
  protected PropertyDef findPropertyDef() throws PropertyException {
    return new LearningActivityPropertyDef(uolId, propId);
  }
}
