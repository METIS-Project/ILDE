...
/**
 * The class represent the IMS LD Play. A PlayProperty inherits from
 * Activities.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.10 $, $Date: 2005/01/21 10:58:49 $
 */
public class PlayProperty extends Activities {
   ...
   */    
  public PlayProperty(Uol uol, Run run, User user, String propId) throws
      PropertyException{
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new PlayPropertyDef(uolId, propId);
  }
}
