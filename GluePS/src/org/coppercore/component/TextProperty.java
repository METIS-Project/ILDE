...
/**
 * This Property represents an IMS LD boolean Property. It extends
 * ExplicitProperty adding type cast and restriction checking to the standard
 * Property mechanism.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.10 $, $Date: 2005/01/19 16:31:28 $
 */
public class TextProperty extends ExplicitProperty {
   ...
   */
  public TextProperty(Uol uol, Run run, User user, String propId) throws
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new TextPropertyDef(uolId, propId);
  }
