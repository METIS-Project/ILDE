...
/**
 * This Property represents an IMS LD duration Property. It extends
 * ExplicitProperty adding type cast and restriction checking to the standard
 * Property mechanism.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.9 $, $Date: 2005/01/19 16:31:27 $
 */
public class DurationProperty extends ExplicitProperty {
   ...
   * 
   * @param uol
   *          Uol the Uol in which this Property was declared
   * @param run
   *          Run the Run in which this Property was referenced
   * @param user
   *          User the User referring to this Property
   * @param propId
   *          String the identifier of this Property as defined in the IMS LD
   *          instance
   * @throws PropertyException
   *           when the constructor fails to create this Property
   * @throws TypeCastException
   *           when the stored value can not be type casted to the type of the
   *           Property. This may occur especially after republication of the
   *           IMS LD instance.
   */
  public DurationProperty(Uol uol, Run run, User user, String propId) throws PropertyException, TypeCastException {
  ...
  protected PropertyDef findPropertyDef() throws PropertyException {
    return new DurationPropertyDef(uolId, propId);
  }
   ...
   * @throws TypeCastException
   *           when the passed value can not be converted to the required
   *           LDDataType
   * @return LDDataType the LDDataType object representing the value
   */
  protected LDDataType createPropertyValue(String aValue) throws TypeCastException {
    if (aValue != null) {
      return new LDDuration(aValue);
    }
