...
/**
 * This class represents the definition of IMS-LD string property.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.23 $, $Date: 2005/01/19 16:31:28 $
 */
public class StringPropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 42L;

  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDSTRING_NAME;
   ...
   */
  public StringPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public StringPropertyDef(int uolId, String propId, int scope, String dataType,
   ...
   */
  public StringPropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
