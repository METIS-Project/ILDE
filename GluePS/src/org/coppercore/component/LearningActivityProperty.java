...
/**
 * The class represent the IMS LD LearningActivity. An LearningActivityProperty is an instance of a
 * Activities.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.12 $, $Date: 2005/01/20 16:12:05 $
 */
public class LearningActivityProperty extends Activities {
   ...
   */  
  public LearningActivityProperty(Uol uol, Run run, User user, String propId) throws
      PropertyException {
