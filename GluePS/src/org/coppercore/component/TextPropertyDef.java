...
/**
 * This class represents the definition of IMS-LD text property.
 *
...
public class TextPropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 42L;

  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDTEXT_NAME;
   ...
   */
  public TextPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public TextPropertyDef(int uolId, String propId, int scope, String dataType,
   ...
   */
  public TextPropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
