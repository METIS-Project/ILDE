...
/**
 * The class represent the IMS LD defintion of an UnitOfLearningPropertyDef.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.11 $, $Date: 2005/02/11 09:34:13 $
 */
public class UnitOfLearningPropertyDef extends CompletionComponentDef {
   ...
   */
  public final static String DATATYPE = "unit-of-learning";
   ...
   */
  public UnitOfLearningPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   *          String the identifier of this component as defined in IMS LD
   * @param completed
   *          String representation of the completion value. Valid values are
   *          true, false and unlimited
   * @param contentXml
   ...
   */
  public UnitOfLearningPropertyDef(int uolId, String propId, String completed, String contentXml, Collection items) {
