...
/**
 * The class represent the IMS LD UnitOfLearning. An UnitOfLearningProperty is an instance of a
 * CompletionComponent.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.8 $, $Date: 2005/01/20 16:12:05 $
 */
public class UnitOfLearningProperty
    extends CompletionComponent {
   ...
   */  
  public UnitOfLearningProperty(Uol uol, Run run, User user, String propId) throws
      PropertyException {
  ...
  protected PropertyDef findPropertyDef() throws
      PropertyException {
    return new UnitOfLearningPropertyDef(uolId, propId);
  }
}
