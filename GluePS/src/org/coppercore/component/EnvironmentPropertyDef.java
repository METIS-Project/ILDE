 ...
 * @version $Revision: 1.10 $, $Date: 2005/01/21 10:58:48 $
 */
public class EnvironmentPropertyDef extends LocalPersonalContentDef {
   ...
   */
  public static final String DATATYPE = "environment";
   ...
   */
  public EnvironmentPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public EnvironmentPropertyDef(int uolId, String propId, String contentXml, Collection items) {
    // although an environment has no explicit initial visibility we will set it
    // to true, so it may be hidden.
    super(uolId, propId, "true", contentXml, items);
