...
/**
 * The class represent the IMS LD LearningObject. A LearningObjectProperty
 * inherits from LocalPersonalContentProperty.
 * 
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.9 $, $Date: 2005/01/21 10:58:49 $
 */
public class LearningObjectProperty extends LocalPersonalContent {
   ...
   */  
  public LearningObjectProperty(Uol uol, Run run, User user, String propId) throws PropertyException {
  ...
  protected PropertyDef findPropertyDef() throws PropertyException {
    return new LearningObjectPropertyDef(uolId, propId);
  }
}
