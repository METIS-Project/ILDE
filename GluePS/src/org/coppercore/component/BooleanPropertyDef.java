...
/**
 * This class represents the definition of IMS-LD boolean property.
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.12 $, $Date: 2005/01/19 16:31:29 $
 */
public class BooleanPropertyDef extends ExplicitPropertyDef {
  private static final long serialVersionUID = 1L;

  /**
   * contains the data type for this Property.
   */
  public static final String DATATYPE = LDDataType.LDBOOLEAN_NAME;
   ...
   */
  public BooleanPropertyDef(int uolId, String propId) throws PropertyException {
    super(uolId, propId);
  }
   ...
   */
  public BooleanPropertyDef(int uolId, String propId, int scope, String dataType,
   ...
   */
  protected BooleanPropertyDef(int uolId, String propId, PropertyDefDto dto) throws
      PropertyException {
