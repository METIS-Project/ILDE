...
/**
 * 
 * This class represents an IMS learning design 'not' element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/21 14:01:30 $
 */
public class IMSLDNotNode
    extends ExpressionEntity {
  
  /**
   * Constructs a IMSLDNotNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDNotNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(notExpression);
  }
