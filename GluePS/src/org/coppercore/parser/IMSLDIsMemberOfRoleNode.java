...
import org.coppercore.expression.IsMemberOfRole;
import org.coppercore.expression.Operand;
import org.w3c.dom.Node;

/**
 * 
 * This class represents an IMS learning design is-member-of-role element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/21 14:01:30 $
 */
public class IMSLDIsMemberOfRoleNode extends IMSLDNode {

  /**
   * Constructs a IMSLDIsMemberOfRoleNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDIsMemberOfRoleNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }

  protected Operand getExpression() throws ValidationException {
    return new IsMemberOfRole(Parser.getNamedAttribute(node,"ref"));
  }
}
