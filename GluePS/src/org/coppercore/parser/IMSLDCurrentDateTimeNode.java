...
/**
 * 
 * This class represents an IMS learning design current-datetime element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/20 16:12:46 $
 */
public class IMSLDCurrentDateTimeNode
    extends IMSLDNode {

  /**
   * Constructs a IMSLDCurrentDateTimeNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDCurrentDateTimeNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
