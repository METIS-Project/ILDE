...
/**
 * 
 * This class represents an IMS learning design environments element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.5 $, $Date: 2005/01/21 14:01:10 $
 */
public class IMSLDEnvironmentsNode extends IMSLDNode {

  /**
   * Constructs a IMSLDEnvironmentsNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDEnvironmentsNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected void parseLDElement(Element childNode, String nodeName) throws Exception {
    ...
    if (nodeName.equals("environment")) {
      addElement(new IMSLDEnvironmentNode(childNode,this));
    }
  }
