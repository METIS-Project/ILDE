...
/**
 * 
 * This class represents an IMS Learning Design 'and' element. 
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/20 16:12:45 $
 */
public class IMSLDAndNode extends ExpressionEntity {

  /**
   * Constructs a IMSLDAndNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDAndNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(andExpression);
  }
