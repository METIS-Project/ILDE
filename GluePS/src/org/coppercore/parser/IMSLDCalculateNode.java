...
/**
 * 
 * This class represents an IMS learning design calculate element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/26 10:55:18 $
 */
public class IMSLDCalculateNode extends ExpressionEntity {

  /**
   * Constructs an IMSLDCalculateNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDCalculateNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
