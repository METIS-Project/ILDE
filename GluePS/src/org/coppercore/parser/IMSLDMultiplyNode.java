...
import org.coppercore.expression.MultiplyExpression;
import org.coppercore.expression.Operand;
import org.w3c.dom.Node;

/**
 * 
 * This class represents an IMS learning design multiply element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/21 14:01:10 $
 */
public class IMSLDMultiplyNode
    extends OperandEntity {

  /**
   * Constructs a IMSLDMultiplyNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDMultiplyNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(multiplyExpression);
  }
