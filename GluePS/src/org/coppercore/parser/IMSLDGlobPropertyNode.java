...
/**
 * 
 * This class represents an IMS learning design glob-property element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.9 $, $Date: 2005/01/21 14:01:11 $
 */
public class IMSLDGlobPropertyNode extends PropertyNode {
  private PropertyNode globalNode = null;

  /**
   * Constructs a IMSLDGlobPropertyNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDGlobPropertyNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected void parseLDElement(Element childNode, String nodeName) throws Exception {
    ...
    if (nodeName.equals("existing")) {
      ...
      globalNode = (PropertyNode) addElement(new IMSLDGlobalDefinitionNode(childNode,this));
    }
  }

  protected int getScope() {
    return PropertyDef.GLOBAL;
  }
