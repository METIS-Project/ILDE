...
import org.coppercore.expression.SubtractExpression;
import org.w3c.dom.Node;

/**
 * 
 * This class represents an IMS learning design subtract element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/21 14:01:31 $
 */
public class IMSLDSubtractNode
    extends OperandEntity {
  
  /**
   * Constructs a IMSLDSubtractNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDSubtractNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(subtractExpression);
  }
