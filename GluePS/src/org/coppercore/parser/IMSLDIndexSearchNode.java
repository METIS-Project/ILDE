...
/**
 * 
 * This class represents an IMS learning design index-search element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.4 $, $Date: 2005/01/21 14:01:30 $
 */
public class IMSLDIndexSearchNode extends IMSLDNode {

  /**
   * Constructs a IMSLDIndexSearchNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDIndexSearchNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }

  protected void writeXMLEnvironmentTree(PrintWriter output) {
    XMLTag tag = new XMLTag("index-search");
