...
import org.coppercore.expression.OrExpression;
import org.w3c.dom.Node;

/**
 * 
 * This class represents an IMS learning design 'or' element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/21 14:01:31 $
 */
public class IMSLDOrNode
    extends ExpressionEntity {
  
  /**
   * Constructs a IMSLDOrNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDOrNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(orExpression);
  }
