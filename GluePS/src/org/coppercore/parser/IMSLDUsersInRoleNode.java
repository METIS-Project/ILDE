...
/**
 * 
 * This class represents an IMS learning design users-in-role element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.11 $, $Date: 2005/01/21 14:01:10 $
 */
public class IMSLDUsersInRoleNode
    extends ExpressionEntity {
  private Object role = null;

  /**
   * Constructs a IMSLDUsersInRoleNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDUsersInRoleNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected void parseLDElement(Element childNode, String nodeName) throws Exception {
    ...
    if (nodeName.equals("role-ref")) {
      ...
      addElement(new IMSLDExpressionNode(childNode, this));
    }
  }
  ...
  protected Operand getExpression() throws ValidationException {
    //create the users in role expression
    Expression usersInRoleExpression = new UsersInRole( ( (
        IMSLDRoleNode) role).
        getIdentifier());
    return getExpression(usersInRoleExpression);
  }
