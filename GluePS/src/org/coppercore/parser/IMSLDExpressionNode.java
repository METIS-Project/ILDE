...
/**
 * 
 * This class represents an IMS learning design expression element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.5 $, $Date: 2005/01/21 14:01:30 $
 */
public class IMSLDExpressionNode
    extends ExpressionEntity {

  /**
   * Constructs a IMSLDExpressionNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDExpressionNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }

  protected Operand getExpression() throws ValidationException {
    //expression element is merely a wrapper for an real expression so skip this level
