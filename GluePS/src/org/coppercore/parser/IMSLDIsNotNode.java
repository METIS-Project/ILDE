...
/**
 * 
 * This class represents an IMS learning design is-not element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/21 14:01:30 $
 */
public class IMSLDIsNotNode extends OperandEntity{
  
  /**
   * Constructs a IMSLDIsNotNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDIsNotNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }

  protected Operand getExpression() throws ValidationException {
    //ISNOT is implemented as nested construction of NotExpression and IsExpression
    IsExpression isExpression = new IsExpression();
    NotExpression notExpression = new NotExpression();
    notExpression.addOperand(getExpression(isExpression));
