...
/**
 * 
 * This class represents an IMS learning design locrole-property element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.8 $, $Date: 2005/01/21 14:01:31 $
 */
public class IMSLDLocRolePropertyNode extends PropertyDefinitionNode {
  private Object role = null;

  /**
   * Constructs a IMSLDLocRolePropertyNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDLocRolePropertyNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected int getScope() {
    return PropertyDef.LOCALROLE;
  }

  protected boolean buildComponentModel(int uolId, MessageList messages) {

   //set the roleId of this role property first
   setRoleId(((IMSLDRoleNode) role).getIdentifier());
