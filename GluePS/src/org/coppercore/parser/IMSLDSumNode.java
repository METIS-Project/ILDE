...
/**
 * 
 * This class represents an IMS learning design sum element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/21 14:01:30 $
 */
public class IMSLDSumNode
    extends OperandEntity {
  
  /**
   * Constructs a IMSLDSumNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDSumNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(sumExpression);
  }
}
