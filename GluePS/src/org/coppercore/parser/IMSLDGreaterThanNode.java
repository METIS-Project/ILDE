...
/**
 * 
 * This class represents an IMS learning design greater-than element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/21 14:01:10 $
 */
public class IMSLDGreaterThanNode
    extends OperandEntity {
  
  /**
   * Constructs a IMSLDGreaterThanNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDGreaterThanNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(greaterThanExpression);
  }
