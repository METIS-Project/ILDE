...
/**
 * 
 * This class represents an IMS learning design 'is' element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.7 $, $Date: 2005/01/21 14:01:10 $
 */
public class IMSLDIsNode extends OperandEntity{
  
  /**
   * Constructs a IMSLDIsNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDIsNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    IsExpression isExpression = new IsExpression();
     ...
     return getExpression(isExpression);
  }
