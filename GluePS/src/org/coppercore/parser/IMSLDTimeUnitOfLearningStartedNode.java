...
/**
 * 
 * This class represents an IMS learning design time-unit-of-learning-started element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.6 $, $Date: 2005/01/21 14:01:29 $
 */
public class IMSLDTimeUnitOfLearningStartedNode
    extends IMSLDNode {
  
  /**
   * Constructs a IMSLDTimeUnitOfLearningStartedNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDTimeUnitOfLearningStartedNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
