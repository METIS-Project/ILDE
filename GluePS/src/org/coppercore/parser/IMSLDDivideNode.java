...
import org.coppercore.expression.DivideExpression;
import org.coppercore.expression.Operand;
import org.w3c.dom.Node;

/**
 * 
 * This class represents an IMS learning design divide element.  
 *
 * @author Harrie Martens
 * @author Hubert Vogten
 * @version $Revision: 1.8 $, $Date: 2005/01/20 16:12:45 $
 */
public class IMSLDDivideNode
    extends OperandEntity {

  /**
   * Constructs a IMSLDDivideNode instance from the passed xml dom element.
   * 
   ...
   */
  public IMSLDDivideNode(Node aNode, IMSLDNode aParent) {
    super(aNode, aParent);
  }
  ...
  protected Operand getExpression() throws ValidationException {
    ...
    return getExpression(divideExpression);
  }
