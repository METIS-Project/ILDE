...
--
-- SQL script TEMPLATE for adding GSIC's Dabbleboard adapter configuration data into the Internal Registry. 
--
...
([SERVIDE_ID], 'http://dabbleboard.com/', CURRENT_TIMESTAMP);
...
([ADAPTER_ID], 'DabbleboardAdapter', 'http://[HOST:PORT]/ToolAdapter/Dabbleboard', CURRENT_TIMESTAMP);
...
([MODEL_ID], 'Dabbleboard LowREST', [ADAPTER_ID], CURRENT_TIMESTAMP);
...
([TOOL_ID], 'Dabbleboard', '','', CURRENT_TIMESTAMP);
...
([TOOL_IMP_ID], [TOOL_ID], [MODEL_ID], [SERVICE_ID], CURRENT_TIMESTAMP, 'feedURL=http%3A%2F%2Fapi.dabbleboard.com%2Fapi%2F&user=[DABBLEBOARD USER NAME]&pass=[DABBLEBOARD PASSWORD]');
