...
the GPL licenses that govern WebContentAdapter, for the purposes here intended.
...
Only the binary jar files needed to run WebContentAdapter have been included.
