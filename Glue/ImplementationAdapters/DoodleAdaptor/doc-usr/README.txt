########################################
# DoodleAdapter                        #
# GSIC's Tool Adapter for Doodle       #
...
the GPL licenses that govern DoodleAdapter, for the purposes here intended.
...
Only the binary jar files needed to run DoodleAdapter have been included. 
None of them was modified by GSIC. If you need a full copy of any third party 
software, visit the web site of its authors.
