...
This product contains some third party libraries provided to make easier the
...
the GPL licenses that govern GDataAdapter, for the purposes here intended.
 ...
 * RESTlet, version 2.0RC4
   by Noelios Technologies
   under Apache 2 license
   placed at GLUE_HOME/lib/dep/restlet-jse-2.0rc4
...
Only the binary jar files needed to run GDataAdapter have been included. 
