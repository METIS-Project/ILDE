########################################
# MediaWikiAdapter                     #
# GSIC's Tool Adapter for MediaWiki    #
...
the GPL licenses that govern MediaWikiAdapter, for the purposes here intended.

The third party software included are:
...
Only the binary jar files needed to run MediaWikiAdapter have been included.
