...
CLASSPATH=$CONF_DIR:$ADAPTER_LIB_DIR/mediawiki-adapter.jar:$GLUE_LIB_DIR/glue-common.jar:$RESTLET_DIR/org.restlet.jar:$RESTLET_DIR/org.restlet.ext.xml.jar:$RESTLET_DIR/org.restlet.ext.atom.jar:$RESTLET_JETTY_CONN

# Go!
cd $DATA_DIR
echo starting MediaWikiAdapter
java -cp $CLASSPATH glue.adapters.implementation.mediawiki.manager.MediaWikiAdapterServerMain >> $LOG_DIR/${ADAPTER_KEY}_adapter.log 2>> $LOG_DIR/${ADAPTER_KEY}_adapter.log &
cd $BACK_DIR
