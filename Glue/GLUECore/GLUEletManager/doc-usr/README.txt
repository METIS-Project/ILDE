...
original licenses. These licenses are compatible with the AGPL license that govern
GLUEletManager, for the purposes here intended.
...
Only the binary jar files needed to run GLUEletManager have been included.
